...
public class ReviewStarsParameters extends TestBase {
    ...
    public void addNoneStarParameters() {
        ...
        List <WebElement> starClasses = app.getWebDriverHelper().getDriver().findElements(By.cssSelector(".form-control-static.row"));
        MatcherAssert.assertThat(starClasses.size(),equalTo(0));
    }
